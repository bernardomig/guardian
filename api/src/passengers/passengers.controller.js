...
const passengersController = {
  ...
  async create(req, res) {
    ...
    res.status(200).json({ uid: query.uid, name: query.name, gender: query.gender, bloodType: query.bloodType, birthday: query.birthday, knownDiseases: query.knownDiseases});
  },
